  ...
  setup() {
      ...
      if (jwtToken) {
        ...
        try {
          const response = await axios.get(
            `https://hr.ultimateit.io/api/Candidature/HasApplied/${userId}/${offreId}`,
            {
              headers: {
    ...
    const fetchOfferData = async () => {
      try {
        ...
        const response = await axios.get(`https://hr.ultimateit.io/api/Offre/${id}`)
    ...
    const handleSave = () => {
      if (jwtToken) {
        ...
        if (decodedToken && decodedToken.role !== 'admin') {
          ...
          Swal.fire({
            title: 'Wainting ...',
            text: 'Applying for this job this can take few seconds.',
          ...
          axios
            .post('https://hr.ultimateit.io/api/Candidature/Postuler', formData, {
              headers: {
