...
export default {
  ...
  setup() {
    ...
    const itemsPerPage = 8 // Nombre d'offres par page
    ...
    const fetchDepartments = async () => {
      try {
        const response = await axios.get('https://hr.ultimateit.io/api/Offre/departements')
    ...
    const fetchJobsList = async () => {
      try {
        const response = await axios.get('https://hr.ultimateit.io/api/Offre/GetOffreEmplois')
    ...
    const fetchIntershipList = async () => {
      try {
        const response = await axios.get('https://hr.ultimateit.io/api/Offre/GetOffreStage')
    ...
    const handleDelete = async (id: string) => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          try {
            const response = await axios.delete(`https://hr.ultimateit.io/api/Offre/DeleteOffre/${id}`)
            Swal.fire({
              icon: 'success',
              title: 'Offer deleted!',
          ...
          <div class="d-sm-flex justify-content-xl-between align-items-center mb-2">
            ...
            <div class="dropdown ml-0 ml-md-4 mt-2 mt-lg-0">
              ...
              >
                ...
                <a class="dropdown-item" @click="selectedDepartment = ''">View all</a>
              </div>
            </div>
          </div>
          <hr />
