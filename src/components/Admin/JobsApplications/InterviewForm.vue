              ...
              <div class="card-body">
                <div class="schedule-interview">
                  ...
                  <form @submit.prevent="submitAppointment">
                    ...
                    <button type="submit" :disabled="isButtonDisabled">Schedule interview</button>
                  </form>
    ...
    const submitAppointment = async () => {
      try {
        ...
        const response = await axios.post(
          'https://hr.ultimateit.io/api/Interview/schedule',
          {
            appUserId,
            offreId,
        ...
        appointmentStatus.value = 'Interview scheduled successfuly !'
        router.push(`/ShowInterviewByOffer/${offreId}`)
        return response
      } catch (error) {
        appointmentStatus.value = 'Error while Scheduling the interview.'
        console.error(error)
      } finally {
