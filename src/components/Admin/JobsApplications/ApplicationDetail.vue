...
export default {
  ...
  setup() {
    ...
    const getCandidatureByUserName = async () => {
      try {
        const response = await axios.get(
          `https://hr.ultimateit.io/api/Candidature/${appUserId}/${offreId}`,
          {
            headers: {
              Authorization: `Bearer ${jwtToken}`
            },
    ...
    const updateDecision = async (decision: string) => {
      try {
        await axios.put(
          `https://hr.ultimateit.io/api/Candidature/update-decision/${appUserId}/${offreId}`,
          { decision },
          {
            headers: {
              Authorization: `Bearer ${jwtToken}`
        ...
        alert('Erreur while updating decision')
      }
    }

    const acceptApplication = () => updateDecision('Approved')
    const rejectApplication = () => updateDecision('Declined')
                ...
                <div class="job-details">
                  ...
                  <div class="detail">
                    ...
                    <div v-if="showIframeCV">
                      <iframe
                        :src="'https://hr.ultimateit.io/api/Candidature/cv/' + candidature.cvFileName"
                  ...
                  <div class="detail">
                    ...
                    <div v-if="showIframe">
                      <iframe
                        :src="
                          'https://hr.ultimateit.io/api/Candidature/lm/' +
                  ...
                  <div class="detail">
                    ...
                    <button
                      ...
                      type="button"
                      :disabled="candidature.decision === 'Approved'"
                    ...
                    <button
                      ...
                      type="button"
                      :disabled="candidature.decision === 'Declined'"
                  ...
                  <button
                    v-if="candidature.decision === 'Approved'"
